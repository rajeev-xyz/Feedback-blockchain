...
if [ $BUILD ];
    ...
    docker build -t reviewer-peer:latest reviewerPeer/
    docker build -t agency-peer:latest agencyPeer/
    #docker build -t shop-peer:latest shopPeer/
    #docker build -t repairshop-peer:latest repairShopPeer/
    docker build -t web:latest web/
    docker build -t reviewer-ca:latest reviewerCA/
    docker build -t agency-ca:latest agencyCA/
